(function( $ ) {
    ...
    $.Shop.prototype = {
        init: function() {
            ...
            this.$shipping = this.$element.find( "#sshiping" );
            this.$subTotal = this.$element.find( "#stotal" );
            this.$shoppingCartActions = this.$element.find( "#shopping-cart-actions" );
            this.$updateCartBin = this.$element.find( "#update-cart" );
            this.$emptyCartBin = this.$element.find( "#empty-cart" );
            ...
            this.paypalBusinessEmail = "bruhmomentum@gmail.com";
            this.paypalURL = "https://www.paypal.com";
        ...
        emptyCart: function() {
            var self = this; 
            if( self.$emptyCartBin.length ) {
                self.$emptyCartBin.on( "click", function() {
                    self._emptyCart();
                } );
            }
        },
